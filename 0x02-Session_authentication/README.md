...
At the end of this project, you are expected to be able to [explain to anyone](https://intranet.hbtn.io/rltoken/vhOzZfYPdPi5_6x66CMzfQ "explain to anyone"), **without the help of Google**:
...
Copy all your work of the [0x06. Basic authentication](https://intranet.hbtn.io/rltoken/8ruHUp_oXn2XvMDJ0Qeg4A "0x06. Basic authentication") project in this new folder.
...
- Overload `def user_id_for_session_id(self, session_id=None):`
  ...
  - Return `None` if the `created_at` + `session_duration` seconds are before the current datetime. [datetime - timedelta](https://intranet.hbtn.io/rltoken/Ng8OnTnemQLLGOOIDXD0Mg "datetime - timedelta")
